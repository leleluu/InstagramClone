...
class FeedCell: UICollectionViewCell {
    ...
    private lazy var profileImageView: UIImageView = {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(showProfileUser))
        iv.isUserInteractionEnabled = true
    ...
    private lazy var userNameButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(showProfileUser), for: .touchUpInside)
        return button
    }()
    ...
    @objc func showProfileUser() {
        ...
        delegate?.cell(self, wantsToShowProfileForUser: viewModel.post.ownerUid)
